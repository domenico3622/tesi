...
input_fasta = "fasta_lievito/UP000002311_559292.fasta"
output_fasta = "cdhit_ready_yeast.fasta"
...
print("\n--- RISULTATI ---")
print(f"Proteine valide salvate per CD-HIT (80-400 aa): {proteine_valide}")
